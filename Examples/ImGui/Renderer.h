...
{
	uint32_t DescriptorTypes[] = { OPENVK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, OPENVK_DESCRIPTOR_TYPE_IMAGE_SAMPLER };
	uint32_t DescriptorCounts[] = { 1, 1 };
	DescriptorPool = OpenVkCreateDescriptorPool(2, DescriptorTypes, DescriptorCounts, true);
}
...
void InitImGui()
{
	...
	InitInfo.DescriptorPool = VkRenderer.DynamicDescriptorPools.DescriptorPools[DescriptorPool.DescriptorPool];
